...
| Model               |  Accuracy  |  Precision |   Recall   | F1-score (Macro) |
| ------------------- | :--------: | :--------: | :--------: | :--------------: |
| **ResNet-18**       |   0.8604   |   0.8527   |   0.8625   |      0.8569      |
| **DenseNet-121**    |   0.8491   |   0.8508   | **0.8901** |      0.8686      |
| **EfficientNet-B0** | **0.8702** |   0.8623   |   0.8691   |      0.8652      |
| **ConvNeXt-Tiny**   |   0.8618   | **0.8898** |   0.8601   |    **0.8733**    |
